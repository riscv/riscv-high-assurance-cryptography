...
. Within protected architectural containers called *Cryptographic Registers*.
  These conceal the secrets once they are written into them together with their metadata.
