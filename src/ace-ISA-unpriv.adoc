...
| `Zlio`         | ACE with support for `ace.input`/`ace.output` operations^2^   | <<ACE-usage-input-output>> | v0.0.0 | --
| `Zlhtrap`      | Support for horizontal trapping   | <<ACE-horizontal-exception-handling>>                   | v0.0.0 | --
| `Zleaes128p`   | AES-128 encryption/decryption     | <<ACE-ECB-mode>>             | v0.0.0          | --
| `Zleaes192p`   | AES-192 encryption/decryption     | <<ACE-ECB-mode>>             | v0.0.0          | --
| `Zleaes256p`   | AES-256 encryption/decryption     | <<ACE-ECB-mode>>             | v0.0.0          | --
| `Zlsm4p`       | ShangMi 4 encryption/decryption   | <<ACE-ECB-mode>>             | v0.0.0          | --
| `Zlctrm`       | CTR mode^3^                       | <<ACE-keystream-modes>>      | v0.0.0          | --
| `Zlxctrm`      | XCTR mode^3^                      | <<ACE-keystream-modes>>      | v0.0.0          | --
| `Zlxexm`       | XEX^4^                            | <<ACE-XEX-XTS-modes>>        | v0.0.0          | --
.2+| `Zlgcmm`    | GCM mode^3^                       | <<ACE-GCM-mode>>             | v0.0.0          | --
|           GCM with set IV^3^                       | <<ACE-GCM-with-IV-mode>>     | v0.0.0          | --
| `Zlgcmsivm`    | GCM-SIV^3^                        | <<ACE-GCM-SIV-mode>>         | v0.0.0          | --
.2+| `Zlocbm`    | OCB3^4^                           | <<ACE-OCB-mode>>             | v0.0.0          | --
|          OCB3 with set IV^4^                       | <<ACE-OCB-mode>>             | v0.0.0          | --
| `Zlcmacm`      | CMAC^3^                           | <<ACE-CMAC-mode>>            | v0.0.0          | --
...
| `Zlhmacm`      | HMAC function with hidden key (with SHA2 when `Zlesha2h` is supported, and with SHA3 when `Zlesha3h` is not supported) | TBD          | v0.0.0          | --
...
| `Zlsecp256r1c` | Arithmetic and signature generation and verification algorithms for the NIST curve secp256r1   | <<ACE-ECC>> | v0.0.0          | --
| `Zlsecp384r1c` | Arithmetic and signature generation and verification algorithms for the NIST curve secp384r1   | <<ACE-ECC>> | v0.0.0          | --
| `Zlsecp521r1c` | Arithmetic and signature generation and verification algorithms for the NIST curve secp521r1   | <<ACE-ECC>> | v0.0.0          | --
| `Zled25519c`   | Arithmetic and signature generation and verification algorithms for the Edwards curve ed25519  | <<ACE-ECC>> | v0.0.0          | --
| `Zled448c`     | Arithmetic and signature generation and verification algorithms for the Edwards curve ed448    | <<ACE-ECC>> | v0.0.0          | --
...
5+| ^3^ The mode is applicable to all versions of AES and to SM4.
5+| ^4^ The mode is applicable to all versions of AES.
|===
...
Permanent, or reconfigurable via a custom hardware authenticated mechanism.                                          | Entire Device |   HW   | [2:0]  |   4
|   4   | ProdScrt                | Identifies device/system type/model (product).
Permanent or reconfigurable like OEMScrt.                                                                            | Entire Device |   HW   | [2:0]  |   5
...
Reconfigurable like OEMScrt.                                                                                         | Entire Device |   HW   | [2:0]  |   6
