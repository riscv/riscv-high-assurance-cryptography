...
|   [45:32] |  14  | _AuxDataLen_      | If different from 0 or 1, indicates that an additional, variable-length, implementation-dependent data section is added to the Content. The length of this _Auxiliary Data Section_ (ADS) is _AuxDataLen_ * 128 bits.
