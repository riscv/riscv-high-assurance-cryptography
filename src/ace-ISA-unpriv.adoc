...
|   [25:21] |   5  | _State_           | Current state of the CR/Algorithm, encoded as an integer.  See <<ACE-State-field>>.
...
Examples include whether the CR is _Unconfigured_, encrypting or decrypting data, absorbing data in a hash/mac/tag, computing elliptic curve point multiples, generating or verifying signatures, or in an error state.
...
===== Definition of Architected Algorithm States
