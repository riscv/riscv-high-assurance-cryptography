...
| `Zlsecp384r1c` | Same as above, but for NIST curve secp384r1.  | <<ACE-ECC>>                          | v0.0.0          | --
| `Zlsecp521r1c` | Point arithmetic and signature generation and
verification algorithms for the NIST curve secp521r1.  | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zled25519c`   | Point arithmetic and signature generation and
verification algorithms for the Edwards curve ed25519. | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zled448c`     | Point arithmetic and signature generation and
verification algorithms for the Edwards curve ed448.   | <<ACE-ECC>>                                    | v0.0.0          | --
