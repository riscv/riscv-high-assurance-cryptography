...
In other cases, an illegal-instruction exception may be raised by other conditions, for instance:
 ...
 . Use an an odd register number in RV32 when a register pair is expected.
 . Use of a vector-version of any ACE instruction when the V extension is not enabled.
