...
When the `#immed7` value is onw of 56, 57, or 58, the instruction is used to initiate provisioning or export/import operations, as described in <<ACE-management-immeds>>.
