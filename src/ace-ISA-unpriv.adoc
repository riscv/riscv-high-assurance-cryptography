...
| `ZlbpP256r1c`  | Same, but for the Brainpool curve brainpoolP256r1.         | TBD                     | v0.0.0          | --
| `ZlbpP256t1c`  | Same, but for the twisted Brainpool curve brainpoolP256t1. | TBD                     | v0.0.0          | --
| `ZlbpP320r1c`  | Same, but for the Brainpool curve brainpoolP320r1.         | TBD                     | v0.0.0          | --
| `ZlbpP320t1c`  | Same, but for the twisted Brainpool curve brainpoolP320t1. | TBD                     | v0.0.0          | --
| `ZlbpP384r1c`  | Same, but for the Brainpool curve brainpoolP384r1.         | TBD                     | v0.0.0          | --
| `ZlbpP384t1c`  | Same, but for the twisted Brainpool curve brainpoolP384t1. | TBD                     | v0.0.0          | --
| `ZlbpP512r1c`  | Same, but for the Brainpool curve brainpoolP512r1.         | TBD                     | v0.0.0          | --
| `ZlbpP512t1c`  | Same, but for the twisted Brainpool curve brainpoolP512t1. | TBD                     | v0.0.0          | --
| `ZlSM2c`       | Same, but for Chinese 256-bit SM2 curve.                   | TBD                     | v0.0.0          | --
