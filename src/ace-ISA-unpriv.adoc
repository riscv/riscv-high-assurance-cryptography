...
The value `3` of bits [5:4] of the _Locality_ field is reserved: the Boot Session Group defines
only _No Boot Binding_ (0), _PhysBootScrt_ (1), and _VirtBootScrt_ (2). A PI or SCC whose
_Locality_ field carries it is invalid Metadata, and the CR transitions to Error State _Invalid_.
