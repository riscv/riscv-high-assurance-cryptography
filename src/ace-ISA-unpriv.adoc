...
+
--
[cols="^6%,<18%,<18%,<58%",options="header"]
|===
...
|  vii | 8                        | `acemarchid`                | Only if 8{interpunct}_AdditionalData_ > `block_base`, which implies that some implementation-dependent Additional Data follows.
|===
--
+
