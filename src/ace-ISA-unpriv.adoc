...
. Support for AES128, AES192, and AES256, in ECB, CBC, CFB, GCM, and GCM-SIV modes, as well as SHA2, as defined in <<ACE-Algorithms>>.
...
[horizontal]
GR1:: _Direct and indirect CR addressing._
...
GR2:: _Register pairs and quartets._
...
GR4:: _Usage Control and State Modifications._
...
GR6:: _A 128-bit MDH in a vector operand._
