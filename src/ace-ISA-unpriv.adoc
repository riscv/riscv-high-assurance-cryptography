 ...
 * secp521r1 (NIST P-521): `b` = 576 (the top 55 bits are zero-padding), `h` = 512, `j` = 512, `u` = 2, `v` = 2.
 * ed25519 cite:[RFC7748]: `b` = 256; `h` = 256; `j` = 256; `u` = 1; `v` = 1.
 * ed448 cite:[RFC7748]: `b` = 480 (the top 32 bits are zero-padding); `h` = 480 (the top 32 bits are zero-padding); `j` = 480 (the top 32 bits are zero-padding); `u` = 1; `v` = 1.
