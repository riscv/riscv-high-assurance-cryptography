...
| `ZlbpP256t1c`  | -- Twisted Brainpool curve brainpoolP256t1. | TBD                                            | v0.0.0          | --
| `ZlbpP320r1c`  | -- Brainpool curve brainpoolP320r1.         | TBD                                            | v0.0.0          | --
| `ZlbpP320t1c`  | -- Twisted Brainpool curve brainpoolP320t1. | TBD                                            | v0.0.0          | --
| `ZlbpP384r1c`  | -- Brainpool curve brainpoolP384r1.         | TBD                                            | v0.0.0          | --
| `ZlbpP384t1c`  | -- Twisted Brainpool curve brainpoolP384t1. | TBD                                            | v0.0.0          | --
| `ZlbpP512r1c`  | -- Brainpool curve brainpoolP512r1.         | TBD                                            | v0.0.0          | --
| `ZlbpP512t1c`  | -- Twisted Brainpool curve brainpoolP512t1. | TBD                                            | v0.0.0          | --
...
| 255  | ace_err_not_infty          | Used in special cases (such as a non-infinity point on an elliptic curve)
|===
 ...
 * ed448 cite:[RFC7748]: `b` = 480 (the top 32 bits are zero-padding); `h` = 480 (the 32 most significant bits are zero-padding); `j` = 480 (the 32 most significant bits are zero-padding); `u` = 1; `v` = 1.
 * brainpoolP256r1: `b` = 256; `h` = 256; `j` = 256; `u` = 2; `v` = 2.
 * brainpoolP256t1: `b` = 256; `h` = 256; `j` = 256; `u` = 2; `v` = 2.
 * brainpoolP384r1: `b` = 384; `h` = 384; `j` = 384; `u` = 2; `v` = 2.
 * brainpoolP384t1: `b` = 384; `h` = 384; `j` = 384; `u` = 2; `v` = 2.
 * brainpoolP512r1: `b` = 512; `h` = 512; `j` = 512; `u` = 2; `v` = 2.
 * brainpoolP512t1: `b` = 512; `h` = 512; `j` = 512; `u` = 2; `v` = 2.
 ...
 ** If a Form A `ace.state` is used to request a transition to _get_gen_infty_, resp., _get_secondpt_infty_,
 `aceerror` is set to ace_err_not_infty if the `Generator`, resp., `SecondPt` is not at infinity, else `aceerror` is set to zero.
 If `HasSecondPt` is false, and the requested state is _get_secondpt_infty_, then `aceerror` is set to ace_err_invalid_value.
 The state of the CC is _not_ changed.
...
Depending on the algorithm, in states _set_generator_ or _set_secondpt_ we may input non-compressed or compressed points.
