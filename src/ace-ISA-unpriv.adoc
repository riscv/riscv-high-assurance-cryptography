...
ACE provides a number of unprivileged and privileged CSRs.
...
<<ACE-pseudocode-GCM-encryption,ACE-pseudocode-GCM-decryption>>
provide pseudocode for GCM encryption
...
Consequently, an implementation of GCM based on an ECB mode CC is possible, and we include it as an example is <<[ACE-pseudocode-GCM-encryption-alternate>>.
