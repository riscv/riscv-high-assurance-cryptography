...
The conversion of from an internally decrypted format back to the internal encrypted format is performed

and when `ace.mgmt` is used to initiate the import of a SCC.
