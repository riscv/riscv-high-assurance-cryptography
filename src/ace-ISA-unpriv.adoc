...
MMR3:: ACE memory instructions may be decomposed into component memory operations of any granularity.
...
MMR4:: Other harts observe these component memory operations as ordinary memory operations under RVWMO.
