...
|  0xXXX-0xXXX+1   |    URW    | `acesivlh`/`acesivhh`       | RV32 only: Shadows of bits [63:31] of `acesivl`/`acesivh`
|  0xXXX-0xXXX+1   |    URW    | `acesiv2lh`/`acesiv2hh`     | RV32 only: Shadows of bits [63:31] of `acesiv2l`/`acesiv2h`
|  0xXXX-0xXXX+1   |    URW    | `aceiqlh`/`aceiqhh`         | RV32 only: Shadows of bits [63:31] of `aceiql`/`aceiqh`
...
bits [0:63] and [64:127] of the SIV value, respectively.

On RV32,
CSR `acesivlh` shadows bits [62:32] of `acesivl`, and
CSR `acesivhh` shadows bits [62:32] of `acesivh`,
...
bits [0:63] and [64:127] of the SIV2 value, respectively.

On RV32,
CSR `acesiv2lh` shadows bits [62:32] of `acesiv2l`, and
CSR `acesiv2hh` shadows bits [62:32] of `acesiv2h`,
to allow access to those bits.
...
bits [0:63] and [64:127] of the IMPQUAL value, respectively.

On RV32,
CSR `aceiqlh` shadows bits [62:32] of `aceiql`, and
CSR `aceiqhh` shadows bits [62:32] of `aceiqh`,
to allow access to those bits.
