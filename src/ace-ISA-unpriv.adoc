...
|  vii | 8                        | `marchid`                   | Only if 8{interpunct}_AdditionalData_ > `block_base`, which implies that some implementation-dependent Additional Data follows.
|===
--
+
...
If _AdditionalData_ > `varlen`, Position xvi contains the microarchitectural dependent part, which starts with `marchid`.
--
+
