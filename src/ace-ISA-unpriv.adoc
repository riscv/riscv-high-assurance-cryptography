...
Therefore, it is an XLEN-bit CSR.
...
[WARNING]
====
We need to determine the states for:

. Selection of the KDF (the NIST recommended methods and the chinese one);
. Decide whether to absorb additional data into the state;
. Eventually, absorb this data; and
. Finalize and output.
====
