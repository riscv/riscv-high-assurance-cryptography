...
software supplies as part of the entire MDH block: the _ConfigStatus_ field identifies the payload
...
The MDH must be read from the CR using `ace.getmd` into a pair of GPRs (quartet for RV32) or `ace.getmdv` into a vector register of length at least 128 bits,
