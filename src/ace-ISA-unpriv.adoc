...
|  27    | `ace_state_cr_import_auth`  | _Auth_Failed_     | Authentication failure while completing an SCC import.
...
The `ace.mv` instructions used CR management code honor `acestart` as well.
