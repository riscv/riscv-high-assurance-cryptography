...
3+| ^2^ The mode is applicable to all versions of AES, to SM4, and in general to any block cipher with a compatible block size.
|===
...
|   [61:46] |  16  | _AuxInfo_         | Algorithm specific auxiliary information. Currently used only by ML_KEM and ML-DSA. This field is zero if the algorithm that does not use it.
