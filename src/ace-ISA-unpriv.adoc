...
|   59   | `ace_cfgst_exporting_pp` | A partially provisioned CR has been placed in exporting mode.
|   60   | `ace_cfgst_importing_pp` | A partially provisioned CR which has been exported is being reimported.
|   61   | `ace_cfgst_exporting_es` | A CR in an Error State has been placed in exporting mode.
|   62   | `ace_cfgst_importing_es` | A CR in an Error State which has been exported is being reimported.
...
are allowed in States _ace_cfgst_provisioning_, _ace_cfgst_importing_, _ace_cfgst_importing_pp_, and _ace_cfgst_exporting_es_,

SGR18:: `ace.store` and `ace.mv` with a CR as source
are allowed in States _ace_cfgst_exporting_, _ace_cfgst_exporting_pp_, and _ace_cfgst_exporting_es_.
...
| `ace_cfgst_provisioning`, `ace_cfgst_importing`, `ace_cfgst_importing_pp`, `ace_cfgst_importing_es`
...
| `ace_cfgst_exporting`, `ace_cfgst_exporting_pp`, `ace_cfgst_exporting_es`
...
.. `ace_cfgst_importing_es` if the data to import corresponds to an CR in an Error State, and
...
.. `ace_cfgst_exporting_es` if CR is in an Error State, and
...
// 61  `ace_cfgst_exporting_es`
// 62  `ace_cfgst_importing_es`
...
... If `ml`._State_ is an Error State, then CR._State_ is set to `ace_cfgst_importing_es`;
...
. `ace_cfgst_importing`, `ace_cfgst_importing_pp`, or `ace_cfgst_importing_es`, resp.
. `ace_cfgst_exporting`, `ace_cfgst_exporting_pp`, or `ace_cfgst_exporting_es`,
...
... if `ml`._State_ is an Error State, CR's _State_ is set to `ace_cfgst_exporting_es`.
...
. If the MDH._State_ is an Incomplete State, then:
  ...
  .. If the MDH._State_ is `ace_cfgst_{importing|exporting}_es`, then: 16.
...
. If the MDH._State_ is an Incomplete State, then:
  ...
  .. If the MDH._State_ is `ace_cfgst_{importing|exporting}_es`, then: 0.
  .. If the MDH._State_ is `ace_cfgst_{importing|exporting}`, then:
...
. If the MDH._State_ is an Incomplete State, then:
  ...
  .. If the MDH._State_ is `ace_cfgst_{importing|exporting}_es`, then: 16 * (1-`q`) .
  .. If the MDH._State_ is `ace_cfgst_{importing|exporting}`, then:
