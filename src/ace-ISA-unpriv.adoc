...
+
--
Any of the following conditions raises an illegal-instruction exception. All are defects in the
*encoding* of the instruction, so none of them can arise together with `ace_exc_no_csk`, which
requires a well-formed instruction; the relative priority of the two is therefore immaterial.
