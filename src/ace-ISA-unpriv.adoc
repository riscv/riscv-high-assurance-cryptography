...
If this pointer is NULL, horizontal traps on ACE exceptions are disabled.
...
[source,sail]
--
include::../sail-riscv/model/extensions/L/l_ace_clear.sail[]
--

Operation `ace.reset`::
[source,sail]
--
include::../sail-riscv/model/extensions/L/l_ace_reset.sail[]
--
...
Operation `ace.size`: `F` = `0b00`, `r` = `0` ::
[source,sail]
--
include::../sail-riscv/model/extensions/L/l_ace_size_f0.sail[]
--

Operation `ace.size`: `F` = `0b01`, `r` = `0` ::
[source,sail]
--
include::../sail-riscv/model/extensions/L/l_ace_size_f1.sail[]
--

Operation `ace.size`: `F` = `0b10`, `r` = `0` ::
[source,sail]
--
include::../sail-riscv/model/extensions/L/l_ace_size_f2.sail[]
--
