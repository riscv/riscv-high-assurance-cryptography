...
[[ACE-iobuf-window-transfer,the ACEIOBUF window transfer]]
*The ACEIOBUF window transfer.* The following holds for `ace.input` and for `ace.output`, and is
...
<<ACE-iobuf-window-transfer>> of <<ACE-instruction-input>> applies, with the direction reversed:
