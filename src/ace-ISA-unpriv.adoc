...
* `Zlsecp256r1c` {implies} Support for the NIST ECC curves secp256r1 and algorithms—the `c` at the end denotes an elliptic curve.
* `Zlsecp384r1c` {implies} Support for the NIST ECC curves secp384r1 and algorithms.
* `Zlsecp521r1c` {implies} Support for the NIST ECC curves secp521r1 and algorithms.
...
* `Zlhtrap` {implies} Support for horizontal trapping.
...
| `Zlv`    | v0.0.0          | (not yet ratified)
| `Zlio`   | v0.0.0          | (not yet ratified)
|===
...
|===
|Extension | Minimum version | Lifecycle state
| `Zlhtrap` | v0.0.0          | (not yet ratified)
|===
...
|===
|Extension | Minimum version | Lifecycle state
| `Zlv` (Forms A-D)    | v0.0.0          | (not yet ratified)
| `Zlio` (Forms D)     | v0.0.0          | (not yet ratified)
|===
...
|===
|Extension | Minimum version | Lifecycle state
| `Zlv` (Forms A-C)   | v0.0.0          | (not yet ratified)
| `Zlio` (Forms A-D)  | v0.0.0          | (not yet ratified)
|===
...
[%header,cols="15%,40%,17%,13%,15%"]
|===
|Extension       | Algorithms                      | Defined in:                | Minimum version | Lifecycle state
| `Zleaes128p`   | AES-128 encryption/decryption   | <<ACE-ECB-mode>>           | v0.0.0          | (not yet ratified)
| `Zleaes192p`   | AES-192 encryption/decryption   | <<ACE-ECB-mode>>           | v0.0.0          | (not yet ratified)
| `Zleaes256p`   | AES-256 encryption/decryption   | <<ACE-ECB-mode>>           | v0.0.0          | (not yet ratified)
| `Zlsm4p`       | ShangMi 4 encryption/decryption | <<ACE-ECB-mode>>           | v0.0.0          | (not yet ratified)
| `Zlctrm`       | CTR mode^1^                     | <<ACE-keystream-modes>>    | v0.0.0          | (not yet ratified)
| `Zlxctrm`      | XCTR mode^1^                    | <<ACE-keystream-modes>>    | v0.0.0          | (not yet ratified)
| `Zlxexm`       | XEX^2^                          | <<ACE-XEX-XTS-modes>>      | v0.0.0          | (not yet ratified)
.2+| `Zlgcmm`    | GCM mode^1^                     | <<ACE-GCM-mode>>           | v0.0.0          | (not yet ratified)
|           GCM with set IV^1^                     | <<ACE-GCM-with-IV-mode>>   | v0.0.0          | (not yet ratified)
| `Zlgcmsivm`    | GCM-SIV^1^                      | <<ACE-GCM-SIV-mode>>       | v0.0.0          | (not yet ratified)
.2+| `Zlocbm`    | OCB3^2^                         | <<ACE-OCB-mode>>           | v0.0.0          | (not yet ratified)
|          OCB3 with set IV^2^                     | <<ACE-OCB-mode>>           | v0.0.0          | (not yet ratified)
| `Zlcmacm`      | CMAC^1^                         | <<ACE-CMAC-mode>>          | v0.0.0          | (not yet ratified)
| `Zlesha2h`     | SHA-224, SHA-256, SHA-384, SHA-512, SHA-512/224, and SHA-512/256
{empty}                                            | <<ACE-hash-functions>>     | v0.0.0          | (not yet ratified)
| `Zlesha3h`     | SHA3-224, SHA3-256, SHA3-384, SHA3-512, SHAKE128, and SHAKE256
{empty}                                            | <<ACE-SHA-3>>              | v0.0.0          | (not yet ratified)
| `Zlsm3h`       | ShangMi 3 (SM3) hash function   | <<ACE-hash-functions>>     | v0.0.0          | (not yet ratified)
| `Zlascon`      | Ascon-AEAD128 (base, with set Nonce, and with Nonce Masking),
Ascon-Hash256, Ascon-XOF128 and Ascon-CXOF128      | <<ACE-Ascon-AEAD128>> ff.  | v0.0.0          | (not yet ratified)
| `Zlsecp256r1c` | Arithmetic and signature algorithms for the NIST ECC curve secp256r1 | <<ACE-ECC>> | v0.0.0 | (not yet ratified)
| `Zlsecp384r1c` | -- for secp384r1                | <<ACE-ECC>> | v0.0.0          | (not yet ratified)
| `Zlsecp521r1c` | -- for secp521r1                | <<ACE-ECC>> | v0.0.0          | (not yet ratified)
5+| ^1^ The mode is applicable to all versions of AES and to SM4.
5+| ^2^ The mode is applicable to all versions of AES.
|===
