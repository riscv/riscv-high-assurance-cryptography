...
and with SHA3 when `Zlesha3h` is not supported)       | TBD                          | v0.0.0          | --
...
| `Zlsecp256r1c` | Arithmetic and signature generation and
verification algorithms for the NIST curve secp256r1  | <<ACE-ECC>>                  | v0.0.0          | --
| `Zlsecp384r1c` | Arithmetic and signature generation and
verification algorithms for the NIST curve secp384r1  | <<ACE-ECC>>                  | v0.0.0          | --
| `Zlsecp521r1c` | Arithmetic and signature generation and
verification algorithms for the NIST curve secp521r1  | <<ACE-ECC>>                  | v0.0.0          | --
| `Zled25519c`   | Arithmetic and signature generation and
verification algorithms for the Edwards curve ed25519 | <<ACE-ECC>>                  | v0.0.0          | --
| `Zled448c`     | Arithmetic and signature generation and
