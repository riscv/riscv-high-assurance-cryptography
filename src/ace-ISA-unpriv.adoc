...
If they are the same, the CR transitions to Error State `ace_state_invalid`.
...
The use of Additional Data for any information that is not architectural is mandatory.
