...
valid only if the `ConfigStatus` field of the metadata of the CR holds one of the values in its row,
and raises an illegal-instruction exception otherwise. A vector variant further requires
