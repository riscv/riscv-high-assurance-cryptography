...
| `Zlctrm`       | CTR mode and CTR with set initial counter.^4^ | <<ACE-keystream-modes>>               | v0.0.0          | --
| `Zlxctrm`      | XCTR mode and XCTR with set initial counter.^4^ | <<ACE-keystream-modes>>             | v0.0.0          | --
| `Zlxexm`       | XEX construction.^5^                 | <<ACE-XEX-XTS-modes>>                          | v0.0.0          | --
| `Zlgcmm`       | GCM mode and GCM with set IV.^4^     | <<ACE-GCM-mode>>                               | v0.0.0          | --
| `Zlgcmsivm`    | GCM-SIV.^4^                          | <<ACE-GCM-SIV-mode>>                           | v0.0.0          | --
| `Zlocbm`       | OCB3 mode and OCB3 with set IV.^5^   | <<ACE-OCB-mode>>                               | v0.0.0          | --
...
2+| _Point arithmetic and signature generation and verification algorithms:_                 | {empty}   | {empty}         | {empty}
| `Zlsecp256r1c` | — for the NIST curve secp256r1.      | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zlsecp384r1c` | — for the NIST curve secp384r1.      | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zlsecp521r1c` | — for the NIST curve secp521r1.      | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zled25519c`   | — for the Edwards curve ed25519.     | <<ACE-ECC>>                                    | v0.0.0          | --
| `Zled448c`     | — for the Edwards curve ed448.       | <<ACE-ECC>>                                    | v0.0.0          | --
| `ZlbpP256r1c`  | — for the Brainpool curve brainpoolP256r1.         | TBD                              | v0.0.0          | --
| `ZlbpP256t1c`  | — for the twisted Brainpool curve brainpoolP256t1. | TBD                              | v0.0.0          | --
| `ZlbpP320r1c`  | — for the Brainpool curve brainpoolP320r1.         | TBD                              | v0.0.0          | --
| `ZlbpP320t1c`  | — for the twisted Brainpool curve brainpoolP320t1. | TBD                              | v0.0.0          | --
| `ZlbpP384r1c`  | — for the Brainpool curve brainpoolP384r1.         | TBD                              | v0.0.0          | --
| `ZlbpP384t1c`  | — for the twisted Brainpool curve brainpoolP384t1. | TBD                              | v0.0.0          | --
| `ZlbpP512r1c`  | — for the Brainpool curve brainpoolP512r1.         | TBD                              | v0.0.0          | --
| `ZlbpP512t1c`  | — for the twisted Brainpool curve brainpoolP512t1. | TBD                              | v0.0.0          | --
| `ZlSM2c`       | — for Chinese 256-bit SM2 curve.                   | TBD                              | v0.0.0          | --
