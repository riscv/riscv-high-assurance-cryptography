...
The state contains key material and possibly other algorithm-specific data.
...
The metadata field exists in two versions, short (64-bit) and long (128-bit).
The short version is mandatory and is structured as follows:
...
The long version of the metadata is optional, depending on the algorithms and features offered by the implementation, and is structured as follows:
