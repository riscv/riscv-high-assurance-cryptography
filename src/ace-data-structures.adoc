...
|     [0] |   1  | Format                 | 0 for this version of the metadata format. | Public
...
Bit 0 is currently hardwired to zero. We reserve setting it to 1 for future metadata formats that may also be longer (for instance, 128 bits).
