...
Cf. <<stage-field>>.
| [28:25] |   4  | UC_Policy_1   | "UC Policy" means "Use Control Policy". Disallow the _use_ of this CC in User, (Virtual) Supervisor, Hypervisor, resp., Machine Mode if bit 25, 26, 27, resp. 28, is set. Cf. <<stage-no-H-no-VMID>>.
