...
| `ace.enable`    | flag=blocking             |  Enable the feature in the current process domain. Pseudo-operation for a write to a WARL CSR.
| `ace.disable`   |                           |  Disable the feature in the current process domain. Pseudo-operation for a a write to a WARL CSR.
