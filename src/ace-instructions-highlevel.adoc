...
| `ace.config`   | #immed, flag=blocking     |  Enable/Disable the feature in the current process domain and determine how many contexts we need. Pseudo-operation for a write to a WARL CSR.
