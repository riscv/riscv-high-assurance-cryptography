...
Historically, high-assurance environments have relied on Hardware Security Modules (HSMs) cite:[HSM-Overview] or secure coprocessors to isolate cryptographic keys, for instance the Sun Cryptographic Accelerator PCI boards or the IBM 4758/4764/4765 Cryptographic Modules cite:[IBM4758copr.955100].
...
While highly secure, these systems suffer from significant invocation latency and setup overhead. To reduce this latency, modern SoCs utilize Trusted Execution Environments (TEEs) or secure enclaves (e.g., ARM TrustZone cite:[alves2004trustzone], Intel SGX cite:[intel-sgx]).
