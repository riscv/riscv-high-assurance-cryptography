...
The fundamental concept of ACE is the _opaque key_, i.e., a cryptographic key whose value remains hidden during operations.
...
Metadata defines the cryptographic algorithm and optional usage policies, while content stores sensitive material—including keys, secrets, and internal algorithm state.
