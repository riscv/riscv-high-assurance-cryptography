...
V0 ← IV
ace.setst K0, #ace_state_encrypt, V1     // Configure CR for encryption
...
----
V1 ← tag
ace.setst K0, #ace_hash_verify, V1
ace.getst X1, K0
if (X1 !== ace_state_success) then { handle error } // do not use the plaintext if error
----
...
X1 ← remainder
ace.setst K0, #ace_hash_last_block, X1
V0 ← M[16*blocks .. 16*blocks+15]
ace.exec K0, V0

ace.setst K0, #ace_hash_hash_finalize
