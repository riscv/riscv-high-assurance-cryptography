...
The _Atomic Cryptography Extension_ (ACE) is a ISE that provides an interface to high-performance, high-assurance cryptographic operations that do not necessitate exposure of the value of the key to software.
