...
* `ace.size` semantics during provisioning and import are undefined although the canonical code depends on them.
*TBD: Specify the result per `_ConfigStatus_` value.*
