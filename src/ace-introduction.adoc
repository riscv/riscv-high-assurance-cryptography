...
** In fact, ACE's interface can be used also to provide access to public-key and post-quantum algorithms.
...
[.darkred]#*Discussion point:* _We could have used_# `[.darkred]#L#` [.darkred]#_in this document instead of_# `[.darkred]#ACE#` [.darkred]#_and_# `[.darkred]#ace#`[.darkred]#, _but we haven't changed it yet since a different_# `[.darkred]#misa#` [.darkred]#_bit and a different letter may be allocated in the end by the ARC_.#
