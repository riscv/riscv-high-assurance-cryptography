...
* *To be discussed with ARC:*
 ...
 . RVV-mini can be considered finalized. But need detectability and proper coupling to ACE. And a better name.
 . We need a cause/subcause for our traps. We would lie to have a _value_ as well, in order to retrieve the CR number directly (and simplify the handler with respect to handling direct and indirect CR referencing).
