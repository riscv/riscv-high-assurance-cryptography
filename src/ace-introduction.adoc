 ...
 * [.red]#We could use# `[.red]#L#` [.red]#in this document instead of# `[.red]#ace#` [.red]#but we haven't changed it yet since a different# `[.red]#misa#` [.red]#bit and a different letter may ultimately be allocated to the extension. # `[.red]#L#` [.red]# is nice because it goes “beyond K” and is also the initial of “Locker”, which could replace Cryptographic Context.#
