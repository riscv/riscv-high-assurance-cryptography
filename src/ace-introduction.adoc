...
* *To be discussed with ARC:* RVV-mini can be considered finalized. But need detectability and proper coupling to ACE. And a better name.

* We will “`kl`” in this document instead of
  “`ace.`”: `kl` means ACE is a subset of crypto extensions, the “l” is also
  the initial of “Locker”, and Cryptographic Locker will replace Cryptographic Register.
...
* PRIV/UNPRIV: *Have another round at discussing cause numbers for traps.*
