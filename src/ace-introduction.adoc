...
[WARNING]
[.red]#Do we need to use a nonce in# `[.red]#ace.export#`/`[.red]#ace.import#`[.red]#, or could we use it with a non-nonced SIV? This would allow a 96 bit metadata field if we keep the SIV at 96 bits.#
