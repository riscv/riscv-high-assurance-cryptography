...
. Revocation typically targets root keys. Since user software generally uses derived keys, for instance session keys, it suffices that revocation be handled by the trusted entity managing the root keys.
