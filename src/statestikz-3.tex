...
\begin{tikzpicture}[scale=1.1]
  ...
  \node[state, thick] at (8.5,-1.5) (algorithm defined) {\begin{tabular}{@{}c@{}}Algorithm-Defined\end{tabular}};
  \node[state, thick] at (8.5,1.5)  (success failure)   {\begin{tabular}{@{}c@{}}Success/Failure\end{tabular}};
