...
KLEE  the two Machines of `modules/ROOT/pages/Zkl-ISA-machines.adoc` (<<KLEE-process-VLI>>,
      <<KLEE-GCM-mode>>, <<KLEE-GCM-with-IV-mode>>), transcribed literally on
      KLEE values (`modules/ROOT/pages/Zkl-notation.adoc`: byte i at bits [8i+7:8i], the left
