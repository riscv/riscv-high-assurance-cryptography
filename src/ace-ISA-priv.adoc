...
If the metadata record's State field of a CR is _Off_, then this `*s*crstatus` field shall be _Off_ of _Other_.
...
This `*s*crstatus` can be used for lazy context switching at per-CR granularity.
