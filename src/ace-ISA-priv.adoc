...
| `Smacepbootscrt` | Defines the CSRs group to configure the Physical Boot Locality (cf. <<ACE-Localities>>).            | <<ACE-CSR-macephysbootscrt>> | v0.0.0 | --
| `Smacevbootscrt` | Defines the CSRs group to configure the Virtual Boot Locality (cf. <<ACE-Localities>>).          | <<ACE-CSR-hacevirtbootscrt>> | v0.0.0 | --
