...
A lazy-loading mechanism for CRs, besides optimizing the performance of context switching, may be used to load CRs on demand.
This mechanism can also be used asn an optimization or to emulate a larger CRF, and is described here.
