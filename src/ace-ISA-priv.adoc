...
Coming out of state _Off_ does not zeroise or reset the ACE Unit.

Entering ACES state _Off_ does not affect the state, it is only access permission to the ISA and its state (CRs and CSRs).
...
[WARN]
====
Ask the ARC whether it is us must/should.
====
