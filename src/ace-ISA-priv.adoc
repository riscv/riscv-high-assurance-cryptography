...
Since a processes can be interrupted by any one of the higher-privileged modes, U-mode processes may be interrupted for the purpose of context switching by handles at VS-, H-, or even M-mode.
