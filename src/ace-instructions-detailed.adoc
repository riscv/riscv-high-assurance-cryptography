...
|   3   | Other protection, algorithm-specific.
|===
...
A one in the any of the four least significant bits of `Xs` means that the access by the corresponding mode is forbidden. +
