...
* Of the load and store operations, we only need the unit-strided versions.
* Vector `xor`, `and`, `or`, and `vsplatx` to assist implementation of padding or of additional modes or protocols.
