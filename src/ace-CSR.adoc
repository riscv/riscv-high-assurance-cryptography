...
and possibly `vsstatus`[26:25] if the hypervisor extension is present (this uses two of the WPRI (Writes Preserve Values, Reads Ignore Values) bits in these CSRs).
