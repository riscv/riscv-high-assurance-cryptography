...
\pgfdeclareshape{double circle}{
    % Inherit saved anchors and border from circle
    ...
    \backgroundpath{
        ...
        \pgfpathcircle
            ...
            {\radius}
        % Inner circle
        \pgfmathsetlengthmacro{\innersep}{2pt}
        \pgfpathcircle
            {\centerpoint}
            {\radius-\innersep}
    }
...
\draw[-,densely dashed]  (jointoexpired) to[out=3,in=247.5] (success);
