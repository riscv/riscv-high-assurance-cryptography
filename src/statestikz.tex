...
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,0)    (invalid)   {Invalid};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,-2)   (NIMP)      {Not Implemented};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,-3.5) (OOM)       {Out of Memory};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,-5)   (expired)   {Expired};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,2)    (privilege) {\begin{tabular}{@{}c@{}}Privilege\\Violation\end{tabular}};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,3.5)  (authfail)  {\begin{tabular}{@{}c@{}}Authentication\\Failure\end{tabular}};
\node[rectangle, draw=black, semithick, double, rounded corners] at (3,5)    (partial)   {\begin{tabular}{@{}c@{}}Partially\\Configured\end{tabular}};
