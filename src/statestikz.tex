...
\node[circle, draw=black, semithick, double] at (0,0) (off)      {Off\,};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,0)    (invalid)   {Invalid};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,-2)   (NIMP)      {Not Implemented};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,-3.5) (OOM)       {Out of Memory};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,-5)   (expired)   {Expired};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,2)    (privilege) {\begin{tabular}{@{}c@{}}Privilege\\Violation\end{tabular}};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,3.5)  (authfail)  {\begin{tabular}{@{}c@{}}Authentication\\Failure\end{tabular}};
\node[rectangle, minimum height=1.66em, draw=black, semithick, double, rounded corners] at (3,5)    (partial)   {\begin{tabular}{@{}c@{}}Partially\\Configured\end{tabular}};
minimum height=1.66em,
\node[branch] at (5.5,2.625) (joinsome) {};
...
\draw[-,densely dashed]  (initial) to[out=270,in=9,looseness=0.8] (jointoexpired);
...
\draw[->, cross line] (algorithm) to[out=160,in=20]  (invalid);
