...
\begin{tikzpicture}
  ...
  \node[circle,very thick,draw=black] at (5.25,2.625) (joinsome) {};
  \node[above=0mm  of joinsome] (ignore) {\footnotesize \textit{Configuration}};
  ...
  \draw[<->,densely dotted] (joinsome)  to[out=180,in=90,looseness=0.4] ($(initial.west)+(-0.75,0)$) to[out=270,in=10,looseness=0.8] ($(expired.east)+(0,0.1)$);
