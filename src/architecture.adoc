...
* Certain logic operations to help the implementation of additional modes of operation or padding (`and`, `or`, or `xor`).
...
* In case more sophisticated operations are needed, one can always use other operations on GPRs and `vins`/`vext`.
