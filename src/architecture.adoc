...
*To be discussed* We are open to agree on a single metadata format (the 128-bit version).
...
*Remark {counter:remark}*:: For side-channel protection, we currently only require a constant-time and first-order threshold implementation.
