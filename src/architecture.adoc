...
| `ace.spawn`     | Cd\|Xd, Cs\|Xs            |  Optional. Uses the source CC to configure second CC. Used if the source CC is, for instance, a KEM that configures the second CC with a symmetric key. Then, the first CC can be cleared to release resources.
