...
[start=0]
. _CC is unconfigured, and there is a no saved value for the current process._ +
`aceccconfigured[i] = 0`,{nbsp}{nbsp}
`acecccurrent[i] = 0`,{nbsp}{nbsp}
`acecclazy[i] = 0`. +
* In this case it must be `aceccdirty[i] = 0`. +
Using the CC gives an error, no trap. +
* Configuring the CC works as expected, sets: +
`aceccconfigured[i] = 1`,{nbsp}{nbsp}
`acecccurrent[i] = 1`,{nbsp}{nbsp}
`acecclazy[i] = 0`,{nbsp}{nbsp}
and{nbsp}{nbsp} `aceccdirty[i] = 1`.

. _CC is unconfigured, and there is a saved value to be lazy loaded for the current process._ +
`aceccconfigured[i] = 0`,{nbsp}{nbsp}
`acecccurrent[i] = 0`,{nbsp}{nbsp}
`acecclazy[i] = 1`. +
In this case it must be `aceccdirty[i] = 0`. +
...
. _CC is configured for the current process and loaded. Unchanged since last switch._ +
`aceccconfigured[i] = 1`,{nbsp}{nbsp}
`acecccurrent[i] = 1`,{nbsp}{nbsp}
`acecclazy[i] = 0`,{nbsp}{nbsp}
`aceccdirty[i] = 0`. +
...
. _CC is configured for the current process and loaded. Potentially changed since last switch._ +
`aceccconfigured[i] = 1`,{nbsp}{nbsp}
`acecccurrent[i] = 1`,{nbsp}{nbsp}
`acecclazy[i] = 0`,{nbsp}{nbsp}
`aceccdirty[i] = 1`. +
...
. _CC is configured but not for this process, hence blocked for this process, no value to be lazy loaded._ +
`aceccconfigured[i] = 1`,{nbsp}{nbsp}
`acecccurrent[i] = 0`,{nbsp}{nbsp}
`acecclazy[i] = 0`. +
...
. _CC is configured but not for this process, hence blocked for this process, and there is a value to be lazy loaded for the current process._ +
`aceccconfigured[i] = 1`,{nbsp}{nbsp}
`acecccurrent[i] = 0`,{nbsp}{nbsp}
`acecclazy[i] = 1`. +
