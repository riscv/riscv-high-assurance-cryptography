...
* *States:*
 ** _initial_: The CC is just initialised, or reset, and ready to start processing data.
...
State Machine:::
* *States:
  ** _initial_: The CC is just initialised, or reset, and ready to start producing a keystream.
...
* *States:*
 ** _initial_: Freshly initialized of reset.
 ...
 ** _completed_: The algorithm terminated correctly.
...
State Machine:::
* *States:*
 ** _initial_: Freshly initialized or reset.
 ...
 ** _completed_: The algorithm terminated.
...
* *States:* _initial_, _set_aux_value_, _hash_absorb_, _hash_finalize_, _encrypt_, _enc_last_block_, _enc_tag_finalize_, _decrypt_, _dec_last_block_, _hash_verify_, and _completed_.

* *States:*
 ** _initial_: Initialized or reset.
 ** _set_aux_value:_ Set the length and the value of the nonce.1
