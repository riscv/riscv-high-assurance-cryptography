...
`current`:: If the CC is configured, indicates whether the current process is its owner.
...
`[darkred]#configured = 1, current = 1, lazy = 0, dirty = 0.#` +
...
`[darkred]#configured = 1, current = 1, lazy = 0, dirty = 1.#` +
...
`[darkred]#configured = 1, current = 0, lazy = 0.#` +
...
`[darkred]#configured = 1, current = 0, lazy = 1.#` +
