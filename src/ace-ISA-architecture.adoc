...
For this reason, the architecture defines `ace.input` and `ace.output`.
...
[float="center",align="center",width="70%",cols="^8%,<32%,<30%",options="header"]
|===
| Form | Original Instruction          | Replacement
|   A  | `ace.exec{nbsp}Vd, Kn\|K[Xn], Vs` | `ace.input{nbsp}{nbsp}Kn\|K[Xn], Vs` +
`ace.exec{nbsp}{nbsp}{nbsp}Kn\|K[Xn]` +
`ace.output{nbsp}Vd, Kn\|K[Xn]`
|   B  | `ace.exec{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}Kn\|K[Xn], Vs`     | `ace.input{nbsp}{nbsp}Kn\|K[Xn], Vs` +
`ace.exec{nbsp}{nbsp}{nbsp}Kn\|K[Xn]`
