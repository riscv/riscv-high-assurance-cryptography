...
`SCC_content_size()` returns only the length of the content from Position i to Position viii.
...
If _ExtraContent_ != `varlen`, then the Additional Data is placed at Position xvi. For this algorithm, the microarchitectural dependent part is this Additional Data.
