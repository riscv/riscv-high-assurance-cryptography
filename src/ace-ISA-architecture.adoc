...
``sacecrstatus[``2__i__+1,2__i__``]`` can take the values Off, Initial, Clean, and Dirty, as defined for `sstatus.ACES`, for CR #__i__.
...
+
--
*Definition*: Reserved for a future lazy-loading extension (under the name of *LAZY*).
