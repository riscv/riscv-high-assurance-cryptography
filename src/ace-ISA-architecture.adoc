...
StateNumber must always be set to _initial_, _invalid_, and _completed_ if the state of the algorithm corresponds to these states, and to some value other than _initial_, _invalid_, and _completed_  (for instance, 1) if it is in a different state.
