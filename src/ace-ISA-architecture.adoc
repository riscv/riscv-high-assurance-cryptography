...
| [25:24] |   2  | Using_IOBuf            | Zero if using vector registers for the current `ace.exec`. 1 or 2 if using `ace.input`/`ace.output` in place of vector registers. Details in <<ACE-usage-input-output>>.
