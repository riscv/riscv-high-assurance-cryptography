 ...
 ** *Export*: Trigger a trap to the immediately higher mode for lazy loading.
 ...
 The CR is configured with the recovered value and execution of interrupted export restarts from state *CLEAN*.
 ** *Usage*: Trigger a trap to the immediately higher mode for lazy loading. +
 Execution of interrupted instruction restarts from state *CLEAN*.
--
+
