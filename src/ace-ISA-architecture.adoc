...
This is not written explicitly in the algorithm descriptions for brevity.
...
`acesequence` is set to 1. Then, `acesequence` keeps track of how many instructions of the replacement sequence have been completed.
