...
`bytes{nbsp}[{nbsp}{nbsp}8 .. {fournbsp}{nbsp}]{nbsp}{nbsp}` Keys and other secrets.
...
`bytes{nbsp}[{nbsp}24 .. {fournbsp}{nbsp}]{nbsp}{nbsp}` Encrypted Serialized Content of the CR.
