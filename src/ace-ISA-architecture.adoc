...
|  10   | ace_state_encrypt             | In this state encryption is performed, possibly also absorption in a tag computation function.
|  11   | ace_state_decrypt             | In this state decryption is performed, possibly also absorption in a tag computation function.
...
State Machine:::
* *States:* _initial_, _set_public_value_, _set_public_value_2_, _hash_absorb_, _enc_tag_finalize_, _dec_tag_finalize_, _encrypt_, _decrypt_, and _completed_.
...
** For decryption: +
   _initial_ -> _set_public_value_ -> _set_public_value_2_ -> _hash_absorb_ -> _decrypt_ -> _dec_tag_finalize_.
