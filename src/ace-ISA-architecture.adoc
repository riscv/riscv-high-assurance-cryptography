...
+
This is easily solved by using the fourth possible CR status, which we call *LAZY/DIRTY*—this is set by the HV in the expanded `vscrdirty` CSR when it restores the CR before returning control to U-mode.
