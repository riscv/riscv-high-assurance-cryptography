...
Management operations include *configuration* (e.g., CR initialization, import of a SCC, cloning or key derivation from one CR to another) and *export* of a CR as a SCC.
