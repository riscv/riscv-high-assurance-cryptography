...
The PI and SCC formats are described in <<ACE-provisioning-export-import>>.
...
The format of the Metadata is defined in <<ACE-Metadata-header>>, which serves as the header of the data formats used in CR provisioning and in SCC export and import.
