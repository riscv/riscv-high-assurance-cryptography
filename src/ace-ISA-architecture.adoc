...
`bytes{nbsp}[{nbsp}{nbsp}0 .. 7{nbsp}]{nbsp}{nbsp}` Metadata Header, not encrypted. +
`bytes{nbsp}[{nbsp}{nbsp}8 .. {fournbsp}` Keys and other secrets.
...
Format of SCC::: {empty}
`bytes{nbsp}[{nbsp}{nbsp}0 .. 7{nbsp}{nbsp}{nbsp}` Metadata Header, not encrypted. +
`bytes{nbsp}[{nbsp}{nbsp}8 .. 23{nbsp}{nbsp}` SIV produced by the encryption method (128 bits). +
`bytes{nbsp}[{nbsp}24 .. {fournbsp}` Encrypted Serialized Content of the CR.
