...
===== Fine Grained Locker Management with Lazy-Loading: `acealien`
...
*VOID* (`0b000`)::
*Description:* _Locker is unconfigured; there is no saved value for the current process._ +
*Properties:* `configured = 0, lazy = 0.` (Assumed: `dirty = 0` and `alien = 0`.)
...
*LAZY* (`0b100`)::
*Description:* _Locker is unconfigured; parent has saved a value to be lazy-loaded for the current process._ +
*Properties:* `configured = 0, lazy = 1.` (Assumed: `dirty = 0` and `alien = 0`.)
** At context save in privileged code: Nothing to save.
...
*CLEAN* (`0b001`)::
*Description:* _Locker is configured for the current process and loaded. Unchanged since last switch._ +
*Properties:* `configured = 1, alien = 0, lazy = 0, dirty = 0.`
...
*DIRTY* (`0b101`)::
*Description:* _Locker is configured for the current process and loaded. Potentially changed since last switch._ +
*Properties:* `configured = 1, alien = 0, lazy = 0, dirty = 1.`
...
*ALIEN* (`0b011`)::
*Description:* _Locker is configured for an alien process; no value to be lazy-loaded for current process._ +
*Properties:* `configured = 1, alien = 1, lazy = 0.`  (Assumed: `dirty = 0`.)
...
*ALIEN_LAZY* (`0b111`)::
*Description:* _Locker is alien-configured; there is a value to be lazy loaded for the current process._ +
*Properties:* `configured = 1, alien = 1, lazy = 1.`  (Assumed: `dirty = 0`.)
 ** At context save in privileged code: nothing to do.
 ...
 ** `ace.init`:
  ...
  *** in the worst case, a SCC will be 8 bytes longer than the standard size for a complete exported locker for the same algorithm.
