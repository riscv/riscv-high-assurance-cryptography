...
[lowerroman, start=12]
  ...
  . Additional data (as in the *Internal State*). During signature generation this includes a `RandomNumber`, a `b`-bit string, erased upon completion, exported only if the signature operation is interrupted.
