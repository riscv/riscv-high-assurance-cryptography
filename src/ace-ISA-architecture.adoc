...
NOTE: Discoverability of whether the BCTK can be configured or not is not critical, since this is information known by the MM firmware.
...
instruction must be resumable in case of interrupts. This is similar to
