...
In the column "MM-Config." we indicate whether the architecture may allow MM to configure the corresponding Locale Secret.
We also specify the domain of each Locale Secret.
