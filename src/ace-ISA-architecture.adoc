...
The first 64 bits are the metadata header, which is also the header of the data formats used in CR provisioning, and SCC export and import functions.
Its format is given in <<ACE-metadata-header>>
