...
This state change does not occur during `ace.export`, but operations that could modify the internal state should not be performed on a CR with an interrupted export operation.
