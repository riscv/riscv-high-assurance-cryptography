...
If the FilterMode field is non-zero, an additional 128-bit block is added to the metadata to implement filtering according to secrets set by S/VS, HS, and M, and expiration date.
