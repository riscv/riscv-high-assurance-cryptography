...
During init and import, the State_Number field is set to _invalid_, and only at the end of the operation is it set to proper value, i.e., _initial_ or the value in the SCC (see <<ACE-init-export-import>>)
...
A disadvantage could be reduced performance.
