...
* `metadata_serialize(locker) -> byte array`: Serializes the metadata in a locker into a 64-bit block.
...
* `content_serialize(locker) -> byte array`: Serializes the content of the CC in a locker to a byte array.
