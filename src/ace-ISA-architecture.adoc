...
NOTE: The structure of the content section for the Initialization Input and its size must be entirely determined by the Algorithm and Key_Type fields within the metadata.
--
+
...
NOTE: The serialized content's structure and size must be entirely determined by the Algorithm and Key_Type fields within the metadata.
--
+
// Generic Functions:::
