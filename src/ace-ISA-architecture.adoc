...
| [33:32] |   2  | Filter-Mode            | Mode at which apply the filter: 0 = do not apply; 1 = U-mode; 2 = S-mode; 2 = H-mode.
| [55:34] |  22  | Filter                 | A value that has to be matched against the `*acefilter` CSRs. See <<ACE-CSR-filters>> for more details.
