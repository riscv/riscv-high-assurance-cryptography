...
// * `Zll128b` => Minimum Cryptographic Register Length 128-bits
// * `Zll256b` => Minimum Cryptographic Register Length 256-bits
// * `Zll512b` => Minimum Cryptographic Register Length 512-bits (other extensions can be defined, this isn't exhaustive)
// * `Zlr8` => Minimum 8 Cryptographic Registers
// * `Zlr16` => Minimum 16 Cryptographic Registers
// * `Zlr32` => Minimum 32 Cryptographic Registers (other extensions can be defined, this isn't exhaustive)
...
* `Zlsm4p` => Support for AES-256 encryption and decryption (all applicable modes)
