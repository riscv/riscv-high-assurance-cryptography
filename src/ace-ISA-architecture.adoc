...
[NOTE]
====
M-mode firmware must be aware of whether ther CSK us configurable, ephemeral, or fixed. For configurable CSKs, persistence mechanisms are implementation-specific and must be handled by M-mode firmware.
