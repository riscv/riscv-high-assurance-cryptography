...
* `Zleaes128k` => Support for AES-128 encryption and decryption (all modes)
* `Zleaes192k` => Support for AES-128 encryption and decryption (all modes)
* `Zleaes256k` => Support for AES-256 encryption and decryption (all modes)
* `Zlesha2h` => Support for SHA-2 (all modes)
