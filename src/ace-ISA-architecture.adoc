...
. XOR them for the purpose of creating the tweaks to be used in the key derivation process, as, for instance, allowing four to be added together reduces the distinguishability of a sequence or random numbers by just two bits (from 128 to 126)—and these values are never observed directly.
