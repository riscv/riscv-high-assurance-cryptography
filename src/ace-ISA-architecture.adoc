...
[WARNING]
If VS/HS/ cannot import a SCC accessed by some process at U/VS/S
...
[WARNING]
[.red]#In this case, it may be better to delegate addressing this error to a special in-process trapping handler to free other CRs, and we need to define this mechanism.#
