...
| [23:22] |   4  | State (also Direction) | Encoding the current state of the state machine of the algorithm as a number.
...
The semantics and use of `acestart` are described in <<ACE-init-export-import>> and [.red]#TBD#.
