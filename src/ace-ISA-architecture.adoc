...
If the Locality Field of a CC is all zeros, then the RCSK is not tweaked used.
Otherwise, this value minus one is used as an index _i_ in the LST, and the encryption depends on both the RCSK and LST[_i_].
