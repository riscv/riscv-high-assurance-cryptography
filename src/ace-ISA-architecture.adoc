...
An optional, possibly approximated, and implementation-specific mechanism to estimate the required capacity is defined in <<ACE-instruction-size-internal>>.
====
...
Therefore, this would fit in the metatada's `Filter` field's current length of 25 bits. `Filter` can also be expanded to use the currently reserved fields.
...
{reg:[
    ...
    { bits:  3, name: 'ace.import', attr: ['0{nbsp}{nbsp}{nbsp}{nbsp}0{nbsp}{nbsp}{nbsp}{nbsp}S','0{nbsp}{nbsp}{nbsp}{nbsp}1{nbsp}{nbsp}{nbsp}{nbsp}S'] },
    { bits:  5, name: 'Xn' },
    { bits: 12, name: 'imm' },
]}
....
