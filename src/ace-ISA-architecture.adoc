...
|   2   | Clean              | ACE enabled. At least one CR or the ACEIOBUF are configured, and the state matches the last context swap.
...
Similarly to vector register load instructions, `ace.import` appears to other harts as sequences of individual loads.
