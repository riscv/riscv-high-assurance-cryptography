...
beyond the capabilities of, for instance, a compiler on an in-order CPU.
...
for i = 0 to len_in_bytes(PT)/16-1  do
    ...
    V1 ← V1 ⊕ V2                       // CTR encrypt
    V3 ← V3 ⊕ V1                       // Horner scheme add
    V3 ← galois_mult(V4,V3)            // Horner scheme mult
    - store V1 at *(ciphertext+16*i))
    counter ← counter+1

V3 ← V3 ⊕ (len(AD) || len(CT))         // Horner scheme add
V3 ← galois_mult(V4,V3)                // Horner scheme mult
V5[32:0] ← 0                           // Prepare IV || 0 for tag encryption
ace.exec V2, C0, V5
tag ← V3 ⊕ V2                          // Last Horner scheme add
----
