...
** _initial_ -> _set_generator_, _set_scalar_, _set_hash_, _set_public_key_, _sign_generate_, _set_signature_
** It is allowed to freely transition between _set_generator_, _set_scalar_, _set_hash_, and _set_public_key_.
** From any of _initial_, _set_generator_, _set_scalar_, _set_hash_, _set_public_key_:
