...
[.red]#*TBD* _We need an entry in the trap vector table for ACE enablement when ACES=Disabled-Clobbered._#
...
`ccstart` has a similar role in ACE than `vstart` in the V extension.
