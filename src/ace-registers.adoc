...
NOTE: User mode, and even operating systems and hypervisors, need not be aware of the `acectk` block. Other mechanisms could have been chosen to program the CTK, such as a MM-exclusive dedicated hardware interface or memory-mapped interface.
