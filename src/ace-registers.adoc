...
These three groups are: `ace_OS_Secret` (i.e. `OS_Secret0`, `OS_Secret1`, `OS_Secret2`, and `OS_Secret3`),
`ace_Boot_Session` (i.e. `ace_Boot_Session0`, `ace_Boot_Session1`, `ace_Boot_Session2`, and `ace_Boot_Session3`).
