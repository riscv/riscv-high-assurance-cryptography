...
. ACE can bind an opaque key to devices, classes of devices, specific hardware or software environments, or to a single boot cycle. We call such an environments and lifecycles _Loci_ (singular: _Locus_).
