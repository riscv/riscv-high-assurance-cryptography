...
* Length of the content, i.e., secrets and other state information.
* serialization and deserialization of the content.
...
The SCC will however always contain the data in the following formas: +
