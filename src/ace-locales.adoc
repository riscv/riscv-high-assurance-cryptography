...
*Example*: _If a key has the value of “2” in the Locale field of the metadata, then not the CTK, but a value derived from the CTK and the "OEM Secret" will be used for import/export.
