...
| Boot Session              | Regenerated at each (virtual) boot. | Y | 6
...
Machine Mode has the responsibility to "virtualize" the boot session locale secret, i.e., the sixth entry in the LST._
